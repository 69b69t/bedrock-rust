...
pub fn lerp_from_progress(lerp_value: f32, lerp_start: f32, lerp_end: f32, start: f32, end: f32) -> f32 {
    lerp(get_lerp_progress(lerp_value, lerp_start, lerp_end), start, end)
}
